...
public class DashboardPage {
    ...
    private String textLocatorTemplate = "//div[@class='gridRow__grid-row--X9wIq']/a[text()='%s']";

    public By searchField = By.xpath("//input[@placeholder='Search by name']");
    public By editButton = By.xpath("//span[text()='Edit']");
    private By firstDashboard = By.xpath("(//a[@class='gridCell__grid-cell--EIqeC gridCell__align-left--DFXWN dashboardTable__name--t2a89'])[1]");
    ...
    public String getDashboardTitle(){
        return driver.findElement(By.xpath("//li[@class='pageBreadcrumbs__page-breadcrumbs-item--JhXKI']/span")).getText();
    }
